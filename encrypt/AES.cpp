...
void SubBytes(int* _data);            /* FIPS 197  P.16 Figure  6 */
void ShiftRows(int* _data);           /* FIPS 197  P.17 Figure  8 */
void MixColumns(int* _data);               /* FIPS 197  P.18 Figure  9 */
void AddRoundKey(int* _data, int n);          /* FIPS 197  P.19 Figure 10 */
...
int Cipher(int* _data);                    /* FIPS 197  P.15 Figure  5 */
