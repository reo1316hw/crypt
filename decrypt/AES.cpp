...
void invShiftRows(int* _data);        /* FIPS 197  P.22 Figure 13 */
void invSubBytes(int* _data);         /* FIPS 197  P.22 5.3.2 */
void invMixColumns(int* _data, int n); /* FIPS 197  P.23 5.3.3 */
...
int invCipher(int* _data);                 /* FIPS 197  P.21 Figure 12 */
...
/************************************************************/
/* FIPS 197  P.23 5.3.3 */
void invMixColumns(int* _data, int n)
{
    int i, i4, x;
    for (i = 0; i < NB; i++)
    {
